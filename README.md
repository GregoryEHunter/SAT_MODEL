...
Data can be found in the data folder. Most preprocessing is done before training in the the "PaperSatTrainingAndGeneration folder" and in the "Baselines folder" For automatic evaluation the preprocessing is done in AutomaticEvaluation in the "Evaluation folder". The books preambles and other superfluous information was removed manually. First the emeddings must be generated first and this is done with the notebooks in the "Premake_embeddings" Folder. All notebooks should be in the root directory as folder organization was done for ease of understanding. 
